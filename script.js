...
{ id: 13, name: "Aimbody 85% safe rank - Filza", price: 20000, image: "images/aim/aimbody.jpg", category: "fileaim", fileUrl: "https://www.mediafire.com/file/jrxamda6i58hlqi/aimbody.zip/file" },
  ...
  { id: 15, name: "Mod M1887 Minecraft đỏ - Epic", price: 0, image: "images/mod/modm1887mcrdo.jpg", category: "mod", fileUrl: "https://link4m.net/0gHOD" }
];
...
function saveVisitorIP() {
  ...
  fetch('https://ipwho.is/')
    ...
    .then(data => {
      ...
      const ip = data.ip; // IP thật (có thể là IPv4 hoặc IPv6)
